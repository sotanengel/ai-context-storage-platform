...
class SilverNormalizer:
    def normalize(
        ...
        if effective_method == ConversionMethod.DETERMINISTIC:
            return self._convert_deterministic(raw_text, record)
    ...
    def _convert_deterministic(self, raw_text: str, record: BronzeRecord) -> CdmDocument:
        ...
        return converter.convert(raw_text, record.source_uri)
